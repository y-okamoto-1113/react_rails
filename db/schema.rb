...
ActiveRecord::Schema.define(version: 2020_09_21_122646) do

  create_table "airlines", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
    t.string "image_url"
    t.string "slug"
